  ...
  */
  admin: {
    ...
    markdownEditor: {
      ...
      imageFile: 'ছবি বা ভিডিও ফাইল বেছে নিন',
      imageUrl: 'অথবা ছবি বা ভিডিওর ঠিকানা (URL)',
      imageNeeded: 'একটি ছবি বা ভিডিও বেছে নিন অথবা তার ঠিকানা লিখুন।',
...
const en: Dictionary = {
  ...
  admin: {
    ...
    markdownEditor: {
      ...
      imageFile: 'Choose an image or video file',
      imageUrl: 'Image or video address (URL)',
      imageNeeded: 'Choose an image or video, or enter its address.',
