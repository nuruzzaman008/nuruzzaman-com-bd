...
const bn = {
  ...
  */
  messages: {
    title: 'বার্তা',
    intro: 'Support ticket, যোগাযোগ ফর্ম, ছাত্রদের প্রশ্ন আর অনুমোদনের অপেক্ষায় থাকা মন্তব্য, সব এক জায়গায়। এখান থেকেই উত্তর দিন।',
    empty: 'কোনো বার্তা নেই।',
    emptyWaiting: 'উত্তরের অপেক্ষায় কোনো বার্তা নেই।',
    pick: 'বাঁদিক থেকে একটি কথোপকথন বেছে নিন।',
    all: 'সব',
    waiting: 'উত্তর বাকি',
    kinds: {
    ...
    send: 'পাঠান',
    sending: 'পাঠানো হচ্ছে…',
    enterHint: 'Enter চাপলে পাঠানো হবে, Shift+Enter দিলে নতুন লাইন',
    internalNote: 'Internal note (গ্রাহক দেখবেন না)',
    note: 'Internal note',
    resolve: 'সমাধান হয়েছে',
    approve: 'অনুমোদন করুন',
    reject: 'প্রত্যাখ্যান',
    spam: 'Spam',
    readOnly: 'এই প্রশ্নের উত্তর দিতে কোর্স সম্পাদনার অনুমতি লাগে।',
    commentHint: 'মন্তব্যের উত্তর এখানে দেওয়া যায় না; প্রকাশ করবেন কি না, সিদ্ধান্ত দিন।',
    contactHint: 'উত্তরটি প্রেরকের email-এ যাবে।',
    openFull: 'পুরো পাতায় খুলুন',
    close: 'বন্ধ করুন',
    minimize: 'ছোট করুন',
    loadFailed: 'কথোপকথন আনা যায়নি।',
    sendFailed: 'পাঠানো যায়নি। আবার চেষ্টা করুন।',
    support: 'সাপোর্ট টিম',
    you: 'আপনি',
    back: 'সব বার্তা',
    status: {
  ...
  notifications: {
    title: 'নোটিফিকেশন',
    intro: 'আপনার জন্য যা যা ঘটেছে, নতুনগুলো আগে। কোনোটিতে ক্লিক করলে সংশ্লিষ্ট পাতা খুলবে।',
    newSection: 'নতুন',
    earlierSection: 'আগের',
    messagesTab: 'বার্তা',
    reply: 'উত্তর দিন',
    moreOptions: 'আরও অপশন',
    pendingTitle: 'কাজ বাকি',
    pending: {
      payments: 'পেমেন্ট যাচাই',
      risky_payments: 'ঝুঁকিপূর্ণ পেমেন্ট',
      tickets: 'Ticket-এর উত্তর',
      contacts: 'যোগাযোগ বার্তা',
      questions: 'ছাত্রের প্রশ্ন',
      comments: 'মন্তব্য অনুমোদন',
      activations: 'Activation',
      reviews: 'রিভিউয়ের অপেক্ষায় আর্টিকেল',
    },
    allMessages: 'সব বার্তা',
    bell: 'নোটিফিকেশন',
    unreadSuffix: 'টি অপঠিত',
    newSuffix: 'টি নতুন নোটিফিকেশন',
    empty: 'এখনো কোনো নোটিফিকেশন নেই।',
    emptyUnread: 'সব নোটিফিকেশন পড়া হয়েছে।',
    all: 'সব',
    unread: 'অপঠিত',
    allCategories: 'সব ধরন',
    categories: {
      orders: 'অর্ডার ও পেমেন্ট',
      licences: 'লাইসেন্স ও activation',
      support: 'সাপোর্ট',
      learning: 'কোর্স',
      content: 'কনটেন্ট',
      users: 'ব্যবহারকারী',
    ...
    categoryHints: {
      orders: 'পেইড অর্ডার, যাচাইয়ের অপেক্ষায় থাকা bKash/Nagad পেমেন্ট',
      licences: 'নতুন activation অনুরোধ ও তার সিদ্ধান্ত',
      support: 'Support ticket, উত্তর ও যোগাযোগ ফর্মের বার্তা',
      learning: 'ছাত্রদের প্রশ্ন, উত্তর ও কোর্সের ঘোষণা',
      content: 'অনুমোদনের অপেক্ষায় থাকা মন্তব্য',
      users: 'নতুন অ্যাকাউন্ট ও affiliate',
      security: 'ভুল পাসওয়ার্ড বা 2-step কোডে লক হওয়া অ্যাকাউন্ট',
    },
    markRead: 'পড়া হয়েছে',
    markUnread: 'অপঠিত করুন',
    markAllRead: 'সব পড়া হয়েছে',
    delete: 'মুছুন',
    clearRead: 'পড়াগুলো মুছুন',
    viewAll: 'সব নোটিফিকেশন',
    settings: 'সেটিংস',
    emailLog: 'Email লগ',
    loading: 'লোড হচ্ছে…',
    loadFailed: 'নোটিফিকেশন আনা যায়নি।',
    ...
    emailTitle: 'Email-এ কোনগুলো পাবেন',
    emailIntro:
      'নোটিফিকেশন সবসময় এখানে আসবে। নিচে বেছে নিন কোন ধরনের ঘটনায় email-ও পাবেন।',
    save: 'সংরক্ষণ করুন',
    saved: 'সংরক্ষিত হয়েছে।',
    browserTitle: 'এই ব্রাউজারে সতর্কতা',
    browserIntro:
      'পাতা খোলা থাকলে প্রতি ৩০ সেকেন্ডে নতুন নোটিফিকেশন দেখা হয়। এই সেটিং শুধু এই ব্রাউজারের জন্য।',
    desktopToggle: 'নতুন নোটিফিকেশনে desktop notification দেখাও',
    soundToggle: 'নতুন নোটিফিকেশনে হালকা শব্দ করো',
    test: 'পরীক্ষা করুন',
    testTitle: 'পরীক্ষামূলক নোটিফিকেশন',
    testBody: 'এই ব্রাউজারে সতর্কতা চালু আছে।',
    denied: 'ব্রাউজার এই সাইটের notification বন্ধ রেখেছে। ব্রাউজারের site settings থেকে চালু করুন।',
    unsupported: 'এই ব্রাউজারে desktop notification সমর্থিত নয়।',
    log: {
      intro:
        'সাইট থেকে পাঠানো প্রতিটি email ও তার অবস্থা। ব্যর্থ নোটিফিকেশন email প্রতি ১০ মিনিটে নিজে থেকে আবার চেষ্টা হয় (সর্বোচ্চ ৫ বার); এখান থেকে যেকোনো সময় আবার পাঠানো যায়।',
      notDelivering:
        'Email এখন শুধু log-এ লেখা হচ্ছে (mailer: {mailer}), কারও কাছে যাচ্ছে না। MAIL_MAILER ঠিক করুন।',
      sentWeek: 'গত ৭ দিনে পাঠানো',
      pending: 'অপেক্ষমাণ',
      failed: 'ব্যর্থ',
      sent: 'পাঠানো হয়েছে',
      time: 'সময়',
      ...
      action: 'কাজ',
      retry: 'আবার পাঠান',
      retryAll: 'ব্যর্থ ও আটকে থাকা সব আবার পাঠান',
      queued: 'টি email আবার পাঠানোর জন্য queue-তে দেওয়া হয়েছে।',
      sourceAll: 'সব',
      sourceNotification: 'নোটিফিকেশন',
      sourceMail: 'অন্যান্য email',
      failedJobs: 'Queue-তে ব্যর্থ হওয়া email',
      failedJobsIntro:
        'রসিদ, প্রশ্নের উত্তরের মতো email যেগুলো queue job হিসেবেই ব্যর্থ হয়েছে। আবার queue-তে দিলে আবার পাঠানোর চেষ্টা হবে।',
      prune: 'পুরনো রেকর্ড এখনই পরিষ্কার করুন',
      pruneHint:
        '৯০ দিনের পুরনো পড়া নোটিফিকেশন ও ১৮০ দিনের পুরনো পাঠানো email-এর রেকর্ড মুছে যায়। অপঠিত নোটিফিকেশন ও ব্যর্থ email কখনো মোছা হয় না। প্রতিদিন নিজে থেকেও চলে।',
      pruned: 'টি পুরনো রেকর্ড মুছে ফেলা হয়েছে।',
    },
  },
  ...
  admin: {
    ...
    dashboard: {
      ...
      openTickets: 'উত্তরের অপেক্ষায় সাপোর্ট টিকিট',
    ...
    newContent: {
      heading: { post: 'নতুন আর্টিকেল', product: 'নতুন প্রোডাক্ট', page: 'নতুন পাতা' },
      intro: {
        ...
        page: 'শিরোনাম আর ঠিকানা দিন — খসড়া তৈরি হয়ে সম্পাদনার পাতা খুলে যাবে। প্রকাশ করলে পাতাটি nuruzzaman.com.bd/ঠিকানা-তে দেখাবে।',
      },
    ...
    pages: {
      ...
      intro: 'পাতার নামে বা “সম্পাদনা”-তে চাপ দিয়ে লেখা বদলান, যোগ করুন বা আপডেট করুন। নতুন পাতাও এখান থেকে যোগ করা যায়।',
      newPage: 'নতুন পাতা',
      edit: 'সম্পাদনা',
      view: 'সাইটে দেখুন',
      language: 'ভাষা',
    ...
    /** Dashboard → Pages-এর সম্পাদক। */
    pageEditor: {
      title: 'শিরোনাম',
      slug: 'ঠিকানা (slug)',
      slugHint: 'ইংরেজি ছোট হাতের অক্ষর, সংখ্যা আর হাইফেন।',
      slugLocked: 'এটি সাইটের নিজস্ব পাতা, তাই এর ঠিকানা বদলানো যায় না — বদলালে এই পাতার সব লিংক ভেঙে যেত।',
      slugLockedPair: 'এই পাতার অন্য ভাষার সংস্করণ আছে, দুটো একই ঠিকানায় জোড়া — তাই ঠিকানা বদলানো যায় না।',
      address: 'সাইটে ঠিকানা',
      body: 'পাতার লেখা',
      bodyHint: 'ওপরের টুলবার দিয়ে শিরোনাম, তালিকা, লিংক, ছবি আর টেবিল যোগ করুন। “## ” দিয়ে শুরু হওয়া লাইন পাশের সূচিপত্রে দেখায়।',
      template: 'পাতার ধরন',
      templates: { default: 'সাধারণ পাতা', legal: 'আইনি পাতা (নীতি বা শর্ত)', support: 'সাপোর্ট পাতা' },
      templateHint: 'আইনি পাতায় পেশাগত পর্যালোচনা রেকর্ড না হওয়া পর্যন্ত DRAFT নোটিশ দেখায়।',
      metaTitle: 'Meta title',
      metaTitleHint: 'Google-এর ফলাফলে যে শিরোনাম দেখায়। ফাঁকা রাখলে পাতার শিরোনামই ব্যবহার হবে।',
      ...
      publish: 'প্রকাশ করুন',
      publishing: 'প্রকাশ হচ্ছে…',
      saved: 'খসড়া সংরক্ষিত হয়েছে।',
      updated: 'আপডেট হয়েছে — এক মিনিটের মধ্যে সাইটে দেখা যাবে।',
      publishedDone: 'প্রকাশিত হয়েছে — পাতাটি এখন সাইটে দেখা যাচ্ছে।',
      saveFailed: 'সংরক্ষণ করা যায়নি। আবার চেষ্টা করুন।',
      statusFailed: 'অবস্থা পরিবর্তন করা যায়নি।',
      currentStatus: 'বর্তমান অবস্থা',
      liveNote: 'এই পাতাটি সাইটে প্রকাশিত।',
      draftNote: 'এটি এখনো সাইটে দেখা যায় না। প্রকাশ করলে দেখা যাবে।',
      view: 'সাইটে দেখুন',
      backToDraft: 'সাইট থেকে সরিয়ে খসড়ায় নিন',
      archive: 'আর্কাইভ',
      publishNeedsRight: 'প্রকাশ করার অনুমতি আপনার নেই; সংরক্ষণ করুন, একজন অ্যাডমিন প্রকাশ করবেন।',
      sitePage: 'সাইটের নিজস্ব পাতা',
      sitePageNote: 'সাইটের নিজস্ব পাতা সবসময় প্রকাশিত থাকে; এখানে শুধু লেখা বদলান।',
      language: 'ভাষা',
      bengaliVersion: 'বাংলা সংস্করণ',
      englishVersion: 'English সংস্করণ',
      editEnglish: 'English সংস্করণ সম্পাদনা',
      editBengali: 'বাংলা সংস্করণ সম্পাদনা',
      createEnglish: 'English সংস্করণ তৈরি করুন',
      creatingEnglish: 'তৈরি হচ্ছে…',
      englishMissing: 'English সংস্করণ নেই, তাই /en ঠিকানায় বাংলা লেখাটিই একটি নোটিশসহ দেখাচ্ছে। তৈরি করলে বাংলা লেখাটি কপি হয়ে খসড়া হিসেবে খুলবে — অনুবাদ করে প্রকাশ করুন।',
      englishOf: 'এটি একটি বাংলা পাতার English সংস্করণ; /en ঠিকানায় দেখায়।',
      createFailed: 'তৈরি করা যায়নি।',
      legalTitle: 'আইনি পর্যালোচনা',
      legalBody: 'একজন আইনজীবী বা যোগ্য পেশাদার পড়ে অনুমোদন না করা পর্যন্ত সাইটে এই পাতায় DRAFT নোটিশ থাকে।',
      reviewer: 'পর্যালোচকের নাম',
      reviewedBy: 'পর্যালোচনা করেছেন',
      markReviewed: 'পর্যালোচিত হিসেবে রেকর্ড করুন',
      clearReview: 'পর্যালোচনা মুছে দিন',
      reviewerNeeded: 'পর্যালোচকের নাম দিন।',
      reviewFailed: 'পর্যালোচনা রেকর্ড করা যায়নি।',
      remove: 'পাতাটি মুছুন',
      removeConfirm: 'পাতাটি ট্র্যাশে যাবে এবং সাইট থেকে সরে যাবে। নিশ্চিত?',
      removing: 'মোছা হচ্ছে…',
      removeFailed: 'মোছা যায়নি।',
    },
...
const en: Dictionary = {
  ...
  messages: {
    title: 'Messages',
    intro:
      'Support tickets, the contact form, student questions and comments awaiting approval, in one place. Reply from here.',
    empty: 'No messages.',
    emptyWaiting: 'Nothing is waiting for a reply.',
    pick: 'Choose a conversation on the left.',
    all: 'All',
    waiting: 'Waiting',
    kinds: {
      ticket: 'Support ticket',
    ...
    internalNote: 'Internal note (hidden from the customer)',
    note: 'Internal note',
    resolve: 'Mark resolved',
    approve: 'Approve',
    reject: 'Reject',
    spam: 'Spam',
    readOnly: 'Answering this question needs permission to edit the course.',
    commentHint: 'Comments are not replied to here; decide whether to publish it.',
    contactHint: 'The reply goes to the sender by email.',
    openFull: 'Open in full page',
    close: 'Close',
    minimize: 'Minimise',
  ...
  notifications: {
    title: 'Notifications',
    intro: 'Everything that happened for you, newest first. Open one to go to its page.',
    newSection: 'New',
    earlierSection: 'Earlier',
    messagesTab: 'Messages',
    reply: 'Reply',
    moreOptions: 'More options',
    pendingTitle: 'Still to do',
    pending: {
      payments: 'Payments to verify',
      risky_payments: 'Payments held as risky',
      tickets: 'Tickets to answer',
      contacts: 'Contact messages',
      questions: 'Student questions',
      comments: 'Comments to approve',
      activations: 'Activations',
      reviews: 'Articles to review',
    },
    allMessages: 'All messages',
    bell: 'Notifications',
    unreadSuffix: ' unread',
    newSuffix: ' new notifications',
    ...
    categoryHints: {
      orders: 'Paid orders, and bKash/Nagad payments waiting for review',
      licences: 'New activation requests and their decisions',
      support: 'Support tickets, replies and contact form messages',
      learning: 'Student questions, answers and course announcements',
      content: 'Comments awaiting approval',
      users: 'New accounts and affiliates',
      security: 'Accounts locked after wrong passwords or two-step codes',
    },
    markRead: 'Mark read',
    ...
    emailTitle: 'Which ones also arrive by email',
    emailIntro: 'Notifications always arrive here. Choose which kinds also send you an email.',
    save: 'Save',
    saved: 'Saved.',
    browserTitle: 'Alerts in this browser',
    browserIntro:
      'While a page is open it checks for new notifications every 30 seconds. This applies to this browser only.',
    desktopToggle: 'Show a desktop notification for new notifications',
    soundToggle: 'Play a soft sound for new notifications',
    test: 'Test',
    testTitle: 'Test notification',
    testBody: 'Alerts are on in this browser.',
    denied: 'The browser blocks notifications for this site. Allow them in the browser site settings.',
    unsupported: 'This browser does not support desktop notifications.',
    log: {
      intro:
        'Every email the site sent or tried to send. Failed notification emails are retried every 10 minutes (up to 5 times) and can be resent from here at any time.',
      notDelivering:
        'Email is only being written to a log (mailer: {mailer}), not delivered to anyone. Set MAIL_MAILER.',
      sentWeek: 'Sent in the last 7 days',
      pending: 'Pending',
      failed: 'Failed',
      sent: 'Sent',
      time: 'Time',
      ...
      action: 'Action',
      retry: 'Resend',
      retryAll: 'Resend all failed and stuck',
      queued: ' email(s) queued to be sent again.',
      sourceAll: 'All',
      sourceNotification: 'Notifications',
      sourceMail: 'Other emails',
      failedJobs: 'Emails that failed in the queue',
      failedJobsIntro:
        'Emails such as receipts and answers whose queue job failed outright. Putting one back on the queue tries it again.',
      prune: 'Clean up old records now',
      pruneHint:
        'Deletes read notifications older than 90 days and sent email records older than 180. Unread notifications and failed emails are never deleted. Also runs every day on its own.',
      pruned: ' old records deleted.',
    },
  },
  ...
  admin: {
    ...
    dashboard: {
      ...
      openTickets: 'Support tickets waiting for a reply',
    ...
    newContent: {
      heading: { post: 'New article', product: 'New product', page: 'New page' },
      intro: {
        ...
        page: 'A title and an address. The draft is made and the editor opens; once published, the page is at nuruzzaman.com.bd/address.',
      },
    ...
    pages: {
      ...
      intro: 'Open a page by its name or Edit to change, add to or update its text. New pages are added here too.',
      newPage: 'New page',
      edit: 'Edit',
      view: 'View on site',
      language: 'Language',
    ...
    pageEditor: {
      ...
      slugLocked: 'This is one of the site\'s own pages, so its address cannot change: every link to it would break.',
      slugLockedPair: 'This page has a version in the other language paired to the same address, so the address cannot change.',
      address: 'Address on the site',
      body: 'Page text',
      bodyHint: 'Use the toolbar for headings, lists, links, pictures and tables. Lines starting with “## ” appear in the contents beside the page.',
      template: 'Kind of page',
      templates: { default: 'Ordinary page', legal: 'Legal page (policy or terms)', support: 'Support page' },
      templateHint: 'A legal page shows a DRAFT notice until a professional review is recorded.',
      metaTitle: 'Meta title',
      metaTitleHint: 'The title shown in Google results. Left empty, the page title is used.',
      metaDescription: 'Meta description',
      ...
      publishing: 'Publishing…',
      saved: 'Draft saved.',
      updated: 'Updated. The site shows it within a minute.',
      publishedDone: 'Published. The page is on the site now.',
      saveFailed: 'It could not be saved. Please try again.',
      statusFailed: 'The status could not be changed.',
      currentStatus: 'Current status',
      liveNote: 'This page is live on the site.',
      draftNote: 'This is not on the site yet. Publish it to show it.',
      view: 'View on site',
      backToDraft: 'Take off the site (back to draft)',
      archive: 'Archive',
      publishNeedsRight: 'You may not publish. Save it and an admin will publish it.',
      sitePage: 'Site page',
      sitePageNote: 'The site\'s own pages always stay published; change their text here.',
      language: 'Language',
      bengaliVersion: 'Bengali version',
      englishVersion: 'English version',
      editEnglish: 'Edit the English version',
      editBengali: 'Edit the Bengali version',
      createEnglish: 'Create the English version',
      creatingEnglish: 'Creating…',
      englishMissing: 'There is no English version, so the /en address shows the Bengali text with a notice. Creating one copies the Bengali text into a draft to translate and publish.',
      englishOf: 'This is the English version of a Bengali page, shown at its /en address.',
      createFailed: 'It could not be created.',
      legalTitle: 'Legal review',
      legalBody: 'The page shows a DRAFT notice on the site until a lawyer or qualified professional has read and approved it.',
      reviewer: 'Reviewer\'s name',
      reviewedBy: 'Reviewed by',
      markReviewed: 'Record as reviewed',
      clearReview: 'Clear the review',
      reviewerNeeded: 'Give the reviewer\'s name.',
      reviewFailed: 'The review could not be recorded.',
      remove: 'Delete this page',
      removeConfirm: 'The page goes to the trash and off the site. Are you sure?',
      removing: 'Deleting…',
      removeFailed: 'It could not be deleted.',
    },
