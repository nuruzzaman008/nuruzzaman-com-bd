...
const bn = {
  ...
  */
  ...
  learn: {
    ...
    askSubmitted: 'প্রশ্ন জমা হয়েছে। মডারেশনের পর এটি ক্লাসের সবার কাছে দেখা যাবে।',
    askOpen: 'প্রশ্ন করুন',
    ...
    myNotes: 'আমার নোট',
    notesPrivate: 'নোট শুধু আপনি দেখতে পান।',
    newNote: 'নতুন নোট',
...
const en: Dictionary = {
  ...
  learn: {
    ...
    askSubmitted: 'Your question has been submitted. It becomes visible to the class once moderated.',
    askOpen: 'Ask a question',
    askTitle: 'Question title',
    askBody: 'Details',
    askModerationNote:
      'A question is published after moderation. Until then only you and the instructor can see it.',
    askCancel: 'Cancel',
    lessonFiles: 'Lesson files',
    lessonComplete: 'This lesson is complete.',
    myNotes: 'My notes',
    notesPrivate: 'Notes are private to you.',
    newNote: 'New note',
