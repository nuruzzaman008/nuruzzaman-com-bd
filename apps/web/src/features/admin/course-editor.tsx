...
export function CourseEditor({ initial }: { initial?: Curriculum }) {
  ...
  return <div className="space-y-8">
    ...
    <form id="course-details" onSubmit={saveCourse} className="min-w-0 space-y-4">
      ...
      <label className="block">{bn ? 'বিস্তারিত (Markdown)' : 'Description (Markdown)'}<textarea name="description_markdown" rows={12} defaultValue={course?.description_markdown ?? ''} className={input} /></label>
